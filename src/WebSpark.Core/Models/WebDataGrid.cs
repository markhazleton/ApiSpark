...
public class WebDataGrid
{
    ...
    public Models.WebDataGrid.ColumnColl GridColumns { get; }

    /// <summary>
    /// Gets the grid rows.
    /// </summary>
    /// <value>The grid rows.</value>
    public Models.WebDataGrid.RowColl GridRows { get; }
    ...
    public class GridColumn
    {
        ...
        public Models.WebDataGrid.DisplayFormat Format { get; set; }
        ...
        public void SetCommonValues()
        {
            ...
            {
                FixColumnName();
                if (Format == Models.WebDataGrid.DisplayFormat.Number)
                {
                    try
                    {
        ...
        /// <returns>System.String.</returns>
        public string GetFormatTableCell(Models.WebDataGrid.GridRow gRow)
        {
            string myReturn = string.Empty;
    ...
    /// Class RowColl.
    /// </summary>
    public class RowColl : List<Models.WebDataGrid.GridRow>
    {
    }
    ...
    /// Class ColumnColl.
    /// </summary>
    public class ColumnColl : List<Models.WebDataGrid.GridColumn>
    {
        /// <summary>
        ...
        public void Add(string columnName, string sourceName, Models.WebDataGrid.DisplayFormat displayFormat)
        {
            Add(new Models.WebDataGrid.GridColumn() { Name = columnName, SourceName = sourceName, Format = displayFormat });
        }
        ...
        /// <param name="displayFormat">The display format.</param>
        public void Add(string columnName, string sourceName, string displayName, Models.WebDataGrid.DisplayFormat displayFormat)
        {
            Add(new Models.WebDataGrid.GridColumn()
        ...
        internal void Add(string columnName, string sourceName, Models.WebDataGrid.DisplayFormat displayFormat, bool displayOnSummary)
        {
            Add(new Models.WebDataGrid.GridColumn()
            {
                Name = columnName,
    ...
    public string GetDisplayTableHeader()
    {
        ...
        foreach (Models.WebDataGrid.GridColumn gCol in GridColumns)
        {
    ...
    private string FormatHeaderColumn(string myColName)
    {
        ...
        {
            case "NM":
                newColumnName = $"{(Models.WebDataGrid.StrFun.Left(myColName, myColName.Length - 2))} Name";
                break;

            case "CD":
                newColumnName = $"{(Models.WebDataGrid.StrFun.Left(myColName, myColName.Length - 2))} SiteTemplate";
                break;

            case "DS":
                newColumnName = $"{(Models.WebDataGrid.StrFun.Left(myColName, myColName.Length - 2))} Description";
                break;

            case "ID":
                newColumnName = $"{(Models.WebDataGrid.StrFun.Left(myColName, myColName.Length - 2))} Id";
                break;
    ...
    public string GetPropertyValue(object obj, Models.WebDataGrid.GridColumn myCol)
    {
        ...
        {
            List<string> PropertyNameArray = [.. myCol.Name.Split('.')];
    ...
    /// The header items
    /// </summary>
    public List<Models.WebDataGrid.GridColumn> HeaderItems = [];
    ...
    {
        foreach (Models.WebDataGrid.GridColumn x in GridColumns)
        {
            if (x.Name == Name)
            {
    ...
    public void AddHeaderItem(string DisplayName, string Name, bool ShowOnPhone, Models.WebDataGrid.DisplayFormat Display)
    {
        foreach (Models.WebDataGrid.GridColumn x in GridColumns)
        {
            if (x.Name == Name)
    ...
    public string GetCSV()
    {
        ...
        foreach (Models.WebDataGrid.GridColumn column in GridColumns)
        {
        ...
        foreach (Models.WebDataGrid.GridRow row in GridRows)
        {
            foreach (Models.WebDataGrid.GridColumn column in GridColumns)
            {
                //Add the Data rows.
