...
public class SeedDatabase : IDisposable
{
    ...
    public async Task SeedDatabaseAsync()
    {
        ...
        try
        {
            ...
            _context.SaveChanges();
            // Recipe categories and recipes are now seeded via RecipeDbContext in WebSpark.Recipe.
            // Legacy RecipeOld-based seeding removed as part of 006-extract-recipe-library extraction.
        }
        catch (Exception ex)
        {
